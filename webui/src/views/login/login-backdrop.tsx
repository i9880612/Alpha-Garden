// Animation copied from Alpha-Garden-Pro/src/components/ui/sign-in-flow.tsx.
...
const ShaderMaterial = ({
  ...
  useFrame(({ clock }) => {
    ...
    const minFrameInterval = 1 / maxFps;
    if (timestamp - lastFrameTimeRef.current < minFrameInterval) return;
    ...
    for (const uniformName in uniforms) {
      ...
      switch (uniform.type) {
        ...
        case "uniform2f":
          ...
          break;
        default:
          throw new Error(`Invalid uniform type for '${uniformName}'.`);
      }
    }
